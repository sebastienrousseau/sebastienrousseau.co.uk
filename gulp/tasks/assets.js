...
gulp.task('serve', (done) => {
  ...
  gulp.watch([paths.mdFilesGlob, paths.htmlFilesGlob, paths.ymlFilesGlob, paths.rbFilesGlob], gulp.series('build:site', reload));
  ...
  gulp.watch(paths.imageFilesGlob, gulp.series('copy:images', 'images:responsive', reload));
});
