...
echo "Starting deploy to https://sebastienrousseau.com"
...
# Bots need names too
git config --global user.email "sebastien.rousseau@mac.com"
...
echo "Deployed successfully, check out https://sebastienrousseau.com"
